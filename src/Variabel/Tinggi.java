...
public class Tinggi {
    ...
    //buat variabel titik2 range model fuzzy, agar mudah mengganti nilai saat perubahan
    ...
    //buat method mengakses nilai variabel persediaan
    public static double getTinggi() 
    {
        return tinggi;
    }

    //buat method memberikan nilai variabel persediaan
